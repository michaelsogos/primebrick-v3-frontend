<script lang="ts">
  /**
   * Microsoft brand logo icon — the four-color window mark.
   * Used inside the AI model dropdown to identify Phi-family models.
   */
  let { class: className = 'size-4' }: { class?: string } = $props();
</script>

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2499.6 2500" class={className} aria-hidden="true">
