<script lang="ts">
  /**
   * Qwen brand logo icon — sourced from dashboardicons.com.
   * Used inside the AI model dropdown to identify Qwen-family models.
   * Not used in the trigger (which uses brain-circuit from Lucide).
   */
