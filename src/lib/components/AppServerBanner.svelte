...
{#if shellNav.unreachable}
  ...
  >
    ...
    <span class="min-w-0 flex-1 font-medium leading-snug">{$t('app.serverUnreachable')}</span>
...
{:else if shellNav.error}
  ...
  >
    ...
    <span class="min-w-0 flex-1 font-medium leading-snug">{$t('app.modulesLoadFailed')}</span>
